...
namespace Quartz.Examples.Example17
{
    ...
    public class ClusteringJobsExecutionExample : IExample
    {
        ...
        {
            string dbProviderName = "SQLite-Microsoft";
            var dbFilename = $"test-{dbProviderName}.db";
            ...
            Quartz.Util.DBConnectionManager.Instance.AddConnectionProvider("default", new Quartz.Impl.AdoJobStore.Common.DbProvider(dbProviderName, connectionString));
            NameValueCollection properties = new NameValueCollection
            {
                ...
                //["quartz.dataSource.default.provider"] = dbProviderName,
