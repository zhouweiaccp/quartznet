...
namespace Quartz.Examples.Example110
{
    /// <summary> 
    ...
    public class SimpleExample : IExample
    {
        ...
        public virtual void Run()
        {
            ...
            properties["quartz.plugin.xml.fileNames"] = "~/Example110/quartz_jobs.xml";
            log.Info("------- Initializing ----------------------");

            Environment.SetEnvironmentVariable("quartz.config", AppDomain.CurrentDomain.BaseDirectory + "Example110\\quartz.config");
            ...
            //IJobDetail job = JobBuilder.Create<HelloJob12>()
